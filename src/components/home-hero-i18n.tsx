        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2 lg:items-center lg:gap-12">
            <div className="text-center lg:text-left">
              ...
              <h1 className="font-display text-[1.75rem] font-semibold leading-tight tracking-tight text-white min-[380px]:text-3xl sm:text-5xl lg:text-5xl">
                {t("home_hero_title")}
                <span className="mt-1 block text-teal-200 sm:mt-0">
                  {t("home_hero_title_accent")}
                </span>
              </h1>
              <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-teal-100/90 sm:mt-6 sm:text-lg lg:mx-0">
                Free to join. No big agency fee up front. Trusted care for kids, home &amp; pets —
                hosts and sitters in one marketplace.
              </p>
              <div className="mt-8 flex w-full flex-col items-stretch justify-center gap-2.5 sm:mt-10 sm:flex-row sm:items-center sm:gap-3 lg:justify-start">
                <Link
              ...
              <div className="mt-10 grid grid-cols-3 gap-2 border-t border-white/10 pt-8 text-center sm:mt-12 sm:gap-4 sm:pt-10 lg:text-left">
