...
export type Dictionary = {
  ...
  footer_tutoring: string;
  footer_caregiving: string;
  footer_house: string;
  footer_house_swap: string;
  footer_pets: string;
...
const en: Dictionary = {
  ...
  nav_you: "You",
  nav_reviews: "Reviews",
  service_childcare: "Au pair / childcare",
  service_tutoring: "Tutor",
  service_caregiving: "Caregiving",
  service_house_sitting: "House sitting",
  service_house_swap: "House swap",
  service_pet_sitting: "Dog / pet sitter",
  footer_marketplace: "Marketplace",
  footer_trust: "Trust & safety",
  footer_company: "Company",
  footer_childcare: "Au pair / childcare",
  footer_tutoring: "Tutor",
  footer_caregiving: "Caregiving",
  footer_house: "House sitting",
  footer_house_swap: "House swap",
  footer_pets: "Dog / pet sitter",
  ...
  footer_blurb:
    "Trusted care for your family, loved ones, home & pets — au pairs, tutors, caregivers, house sitters, house swaps & dog sitters on one marketplace.",
  home_hero_badge: "AuPairly · au pair · tutor · house swap · pets",
  home_hero_title: "Trusted care for your",
  home_hero_title_accent: "family, loved ones, home & pets.",
  home_hero_body:
    "Au pairs & childcare, tutoring, caregiving, house sitting, house swap, and dog/pet sitting — one trusted brand. Verified people. Match, message, and place with confidence.",
  ...
  home_four_title: "Every kind of care. One AuPairly.",
  home_four_sub:
    "Au pairs, tutors, caregivers, house sitters, house swaps, and dog sitters — same marketplace, verified people.",
  ...
  home_step1_desc:
    "Sign up as a host or sitter. Pick au pair, tutor, caregiving, house sitting, house swap, pet sitting — or mix.",
  ...
  home_for_hosts_body:
    "Need an au pair, tutor, caregiver, house sitter, dog sitter, or a house swap? Post once, choose categories, and message verified members.",
  ...
  home_for_sitters_body:
    "Offer au pair care, tutoring, caregiving, house sitting, dog sitting — or stack several on one profile. Get verified and connect with hosts worldwide.",
  ...
  pricing_desc:
    "Start free. Plus from R99 / 2 weeks or R249 once for 3 months. Premium for max visibility. Once-off Paystack — no auto-renew.",
  ...
  pricing_get_free: "Continue free",
  pricing_get_plan: "Get {name} · R{amount}",
  pricing_current: "Current plan",
  pricing_period_week_hint: "14-day once-off — try unlimited matching for one hiring sprint.",
  pricing_period_quarter_hint:
    "Most popular · billed once for 90 days (card shows ≈ monthly rate).",
  pricing_period_annual_hint: "Full year · save vs four 3-month packs · no auto-renew.",
  ...
  pricing_tier_period_body:
    "Free forever, or Plus / Premium for 2 weeks, 3 months, or a discounted year — always billed once.",
...
const zh: Dictionary = {
  ...
  pricing_desc: "免费开始。Plus 从 R99/2 周或 R249 一次付清 3 个月。Premium 提升曝光。Paystack 一次付清，不自动续费。",
  pricing_period: "计费周期",
  pricing_showing: "价格适用于",
  pricing_for_hosts: "雇主 / 家庭",
  pricing_for_sitters: "照护者",
  pricing_paystack: "Paystack · 兰特",
  pricing_get_free: "继续免费",
  pricing_get_plan: "获取 {name} · R{amount}",
  pricing_current: "当前套餐",
  pricing_period_week_hint: "14 天一次付清——适合一轮短期招聘。",
  pricing_period_quarter_hint: "最受欢迎 · 一次付清 90 天（卡片显示约月价）。",
  pricing_period_annual_hint: "全年 · 比四次 3 个月更省 · 不自动续费。",
  ...
  pricing_tier_period_body: "永久免费，或 Plus / Premium 可选 2 周、3 个月或优惠年付——均为一次付清。",
...
const es: Dictionary = {
  ...
  pricing_desc: "Empieza gratis. Plus desde R99 / 2 semanas o R249 una vez por 3 meses. Premium para máxima visibilidad. Pago único con Paystack — sin renovación automática.",
  ...
  pricing_paystack: "Paystack · ZAR",
  pricing_get_free: "Seguir gratis",
  pricing_get_plan: "Obtener {name} · R{amount}",
  pricing_current: "Plan actual",
  pricing_period_week_hint: "14 días de una sola vez — ideal para una ronda de contratación.",
  pricing_period_quarter_hint: "Más popular · cobro único por 90 días (la tarjeta muestra ≈ mensual).",
  pricing_period_annual_hint: "Año completo · ahorra vs cuatro packs de 3 meses · sin renovación automática.",
  ...
  pricing_tier_period_body: "Gratis siempre, o Plus / Premium por 2 semanas, 3 meses o un año con descuento — siempre cobro único.",
...
const fr: Dictionary = {
  ...
  pricing_desc: "Commencez gratuitement. Plus dès R99 / 2 semaines ou R249 une fois pour 3 mois. Premium pour une visibilité max. Paiement unique Paystack — sans renouvellement auto.",
  ...
  pricing_paystack: "Paystack · ZAR",
  pricing_get_free: "Rester gratuit",
  pricing_get_plan: "Prendre {name} · R{amount}",
  pricing_current: "Offre actuelle",
  pricing_period_week_hint: "14 jours en une fois — idéal pour un sprint de recrutement.",
  pricing_period_quarter_hint: "Le plus populaire · facturé une fois pour 90 jours (≈ tarif mensuel affiché).",
  pricing_period_annual_hint: "Année complète · économisez vs quatre packs de 3 mois · sans renouvellement auto.",
  ...
  pricing_tier_period_body: "Gratuit pour toujours, ou Plus / Premium pour 2 semaines, 3 mois ou une année réduite — toujours facturé une fois.",
...
const de: Dictionary = {
  ...
  pricing_title: "Free, Plus & Premium",
  pricing_desc: "Kostenlos starten. Plus ab R99 / 2 Wochen oder R249 einmal für 3 Monate. Premium für maximale Sichtbarkeit. Einmalzahlung per Paystack — keine Auto-Verlängerung.",
  ...
  pricing_paystack: "Paystack · ZAR",
  pricing_get_free: "Kostenlos bleiben",
  pricing_get_plan: "{name} · R{amount} holen",
  pricing_current: "Aktueller Plan",
  pricing_period_week_hint: "14 Tage einmalig — ideal für einen Hiring-Sprint.",
  pricing_period_quarter_hint: "Am beliebtesten · einmalig für 90 Tage (Karte zeigt ≈ Monatspreis).",
  pricing_period_annual_hint: "Ganzes Jahr · sparen vs. vier 3-Monats-Pakete · keine Auto-Verlängerung.",
  ...
  pricing_tier_period_body: "Für immer gratis, oder Plus / Premium für 2 Wochen, 3 Monate oder ein rabattiertes Jahr — immer einmalig abgerechnet.",
