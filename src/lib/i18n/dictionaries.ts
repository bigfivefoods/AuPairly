...
const en: Dictionary = {
  ...
  pricing_desc:
    "Pick a tier, then choose 2 weeks (R199 on Plus), 3 months (R99/mo on Plus), or annual. Same periods for Plus and Premium.",
...
const zh: Dictionary = {
  ...
  pricing_desc: "选择套餐，再选 2 周（Plus R199）、3 个月（Plus 每月 R99）或年付。Plus 与 Premium 周期相同。",
  pricing_period: "计费周期",
...
const es: Dictionary = {
  ...
  pricing_desc: "Elige un nivel y luego 2 semanas (R199 en Plus), 3 meses (R99/mes en Plus) o anual. Mismos periodos para Plus y Premium.",
...
const fr: Dictionary = {
  ...
  pricing_desc: "Choisissez un niveau, puis 2 semaines (R199 en Plus), 3 mois (R99/mois en Plus) ou annuel. Mêmes périodes pour Plus et Premium.",
...
const de: Dictionary = {
  ...
  pricing_title: "Free, Plus & Premium",
  pricing_desc: "Wählen Sie eine Stufe, dann 2 Wochen (R199 bei Plus), 3 Monate (R99/Monat bei Plus) oder jährlich. Gleiche Perioden für Plus und Premium.",
