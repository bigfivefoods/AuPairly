...
export async function PUT(req: Request) {
  ...
  const profile = await prisma.familyProfile.upsert({
    ...
    create: {
      ...
      jobEntails: body.jobEntails || null,
      visaSupport: body.visaSupport || null,
    ...
    update: {
      ...
      jobEntails: body.jobEntails !== undefined ? body.jobEntails || null : undefined,
      visaSupport: body.visaSupport !== undefined ? body.visaSupport || null : undefined,
